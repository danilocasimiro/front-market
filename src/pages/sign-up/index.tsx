  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="navbar-collapse" id="navigation">
            ...
            <ul className="navbar-nav d-lg-block d-none">
              <li className="nav-item">
                <a href="https://www.creative-tim.com/product/argon-dashboard" className="btn btn-sm mb-0 me-1 bg-gradient-light">Free Download</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <main className="main-content  mt-0">
        <div className={[styles.background, "page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"].join(' ')}>
                ...
                <div className="card-body">
                  <Formik
                    ...
                    onSubmit={async (values, { setSubmitting, setErrors }) => {
                      await UserRegister(values.email, values.password).then(function(result) {
                        router.push('/sign-in');                        
                        setSubmitting(false);
                      }).catch((error) => {
                        if (error.response) {
                      ...
                      <div className="card-body">
                        <form onSubmit={formik.handleSubmit}>
                          ...
                          <div className="flex items-center justify-center">
                            <button
                              type="submit"
                              className="btn bg-gradient-dark w-100 mb-2"
                            >
                  ...
                  <p className="text-sm mt-3 mb-0">Already have an account? <a href="/sign-in" className="text-dark font-weight-bolder">Sign in</a></p>
                </div>
              </div>
            </div>
          </div>
